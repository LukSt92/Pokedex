...
export const PokeCard = ({ name, children, arena = false }) => {
  ...
  return (
    <div
      onClick={handleClick}
      className="relative w-xs border border-border-color rounded-lg flex flex-col items-center p-2 gap-8 bg-gradient-to-r from-bg-prim-color to-bg-sec-color shadow-xl hover:scale-105 transition duration-300"
    >
      <img
